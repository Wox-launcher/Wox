...
func (a *App) acceptQueryCompletionHint() bool {
	...
	if _, err := a.client.SendRequest("QueryCompletionHintAccepted", map[string]string{
		"inputPrefix": hint.InputPrefix, "completionText": hint.CompletionText, "source": hint.Source,
	}); err != nil {
