...
func (a *App) reloadChatResource(raw json.RawMessage) {
	var resource string
...
// applyAIQuestion routes ask_user into the visible shared chat surface and cancels if no chat can answer it.
func (a *App) applyAIQuestion(raw json.RawMessage) error {
