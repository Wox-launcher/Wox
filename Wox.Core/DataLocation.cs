...
public static class DataLocation
{
    ...
    public static readonly string UserInstalledPluginsDirectory = Path.Combine(DataDirectory, "plugins");
    ...
    public static void EnsureDirectoryExist()
    {
        ...
        if (!Directory.Exists(LogHostsDirectory)) Directory.CreateDirectory(LogHostsDirectory);
