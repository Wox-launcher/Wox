    ...
    public class PluginIndicator : IPlugin, IPluginI18n
    {
        ...
        public List<Result> Query(Query query)
        {
            var results = from keyword in PluginManager.NonGlobalPlugins.Keys
                          ...
                          let customizedPluginConfig = UserSettingStorage.Instance.CustomizedPluginConfigs.ContainsKey(metadata.ID) ? null : UserSettingStorage.Instance.CustomizedPluginConfigs[metadata.ID] 
