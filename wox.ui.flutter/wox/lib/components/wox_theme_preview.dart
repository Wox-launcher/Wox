...
class WoxThemePreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (theme.isAutoAppearance) {
      return Padding(padding: const EdgeInsets.fromLTRB(20, 20, 20, 200), child: WoxThemeAutoPreview(theme: theme));
    }
              ...
              child: ListView(
                children: List.generate(5, (index) {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      leading: WoxImageView(woxImage: WoxImage(imageType: WoxImageTypeEnum.WOX_IMAGE_TYPE_SVG.code, imageData: QUERY_ICON_SELECTION_FILE), width: 30),
