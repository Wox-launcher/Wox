...
class WoxQueryRefinementSortView extends WoxQueryRefinementBaseView {
  const WoxQueryRefinementSortView({super.key, required super.launcherController, required super.refinement, required super.selectedValues, required super.onChanged});
