...
void wox_renderer_invalidate_caret(WoxRenderer *renderer);
void wox_renderer_capture_caret(WoxRenderer *renderer, float x, float y, float width, float height);
int32_t wox_renderer_repaint_caret(WoxRenderer *renderer, float scale, float x, float y, float width, float height, uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha);
...
int32_t wox_renderer_floating_material(WoxRenderer *renderer, float x, float y, float width, float height, float radius, float blur_sigma, float blur_margin, uint8_t tint_red, uint8_t tint_green, uint8_t tint_blue, uint8_t tint_alpha, uint8_t edge_red, uint8_t edge_green, uint8_t edge_blue, uint8_t edge_alpha);
