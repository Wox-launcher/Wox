...
func TestConfirmIconButtonGeometryAndCancellation(t *testing.T) {
	props := ConfirmIconButtonProps{ID: "delete", Label: "Delete", ConfirmLabel: "Confirm delete", IdleIcon: woxwidget.Text{Value: "idle"}, Theme: ControlTheme{Error: woxui.Color{R: 200, A: 255}}}
	cancelled := false
	...
	if button.IdleIcon != nil || button.Width != SettingsCompactControlHeight || button.Height != SettingsCompactControlHeight || button.Label != props.ConfirmLabel || button.Background != props.Theme.Error {
