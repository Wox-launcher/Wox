...
func (e emptyAPIImpl) RegisterPluginTool(context.Context, plugin.RegisterPluginToolOption) plugin.RegisterPluginToolResult {
	return plugin.RegisterPluginToolResult{}
}
func (e emptyAPIImpl) UnregisterPluginTool(context.Context, plugin.UnregisterPluginToolOption) plugin.UnregisterPluginToolResult {
	return plugin.UnregisterPluginToolResult{}
}
func (e emptyAPIImpl) ListPluginTools(context.Context, plugin.ListPluginToolsOption) plugin.ListPluginToolsResult {
	return plugin.ListPluginToolsResult{}
}
func (e emptyAPIImpl) InvokePluginTool(context.Context, plugin.InvokePluginToolOption) plugin.InvokePluginToolResult {
...
func (e emptyAPIImpl) UnregisterTriggerKeyword(context.Context, plugin.UnregisterTriggerKeywordOption) plugin.UnregisterTriggerKeywordResult {
