...
func TestConverterRoutingAndCopyActions(t *testing.T) {
	...
	for _, input := range []string{"square root of 625", "cube root of 27", "2 power 10", "cot(1)", "(1h+30min)/2 to minutes", "1/3 to 2 dp", "π to 5 digits", "21 rounded up to nearest 5", "17 rounded down to nearest 3", "meters in 10 km", "seconds in a day", "300 + 20 km", "Tokyo time", "7:30am LAX to Japan", "time difference between Seattle and Moscow", "5.5 minutes as timespan", "03:04:05 + 01:02:03", "time saved 5 min at 1.5x"} {
