...
var (
	...
	sysOnboardingIcon   = common.NewWoxImageSvg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#4f7cff"/><path fill="#fff" d="m16.4 7.6-2.2 6.6-6.6 2.2 2.2-6.6z"/><circle cx="12" cy="12" r="1.5" fill="#4f7cff"/></svg>`)
)
