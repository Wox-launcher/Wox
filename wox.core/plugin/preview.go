...
const (
	...
	// missing query prerequisites. The blocked response uses a zero preview ratio
	// so the launcher shows only the focused settings form.
	...
	// own the same concrete trigger keyword. The blocked response uses a zero
	// preview ratio so the launcher shows only the editable resolver form.
