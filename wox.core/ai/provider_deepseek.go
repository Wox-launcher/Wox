...
func init() {
	providerFactories["deepseek"] = NewDeepSeekProvider
}
...
const deepSeekDefaultHost = "https://api.deepseek.com"

func (p *DeepSeekProvider) GetIcon() common.WoxImage {
...
func (p *DeepSeekProvider) GetDefaultHost() string {
	return deepSeekDefaultHost
}

func NewDeepSeekProvider(ctx context.Context, connectContext setting.AIProvider) Provider {
	if connectContext.Host == "" {
		connectContext.Host = deepSeekDefaultHost
	}
