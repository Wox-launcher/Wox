...
func init() {
	...
	providerFactories["ollama cloud"] = NewOllamaCloudProvider
}
...
const ollamaCloudDefaultHost = "https://ollama.com/v1"
...
func (p *OllamaCloudProvider) GetDefaultHost() string {
	return ollamaCloudDefaultHost
}

func NewOllamaCloudProvider(ctx context.Context, connectContext setting.AIProvider) Provider {
	if connectContext.Host == "" {
		connectContext.Host = ollamaCloudDefaultHost
	}
