...
// GetDecimalSeparator resolves the existing Calculator mode without changing its defaults.
...
// GetThousandsSeparator preserves Calculator grouping conventions for the effective locale.
