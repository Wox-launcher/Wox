...
3. Verified files are atomically installed under `.wox/dictation/<goos>-<goarch>` with the signed manifest cached beside them. Existing caches without valid metadata are replaced.
