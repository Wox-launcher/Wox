...
Actions can install, update, uninstall, open the plugin website, or copy an AI prompt for creating a plugin. You can also create script, single-file, or full plugins from templates.
...
See the [plugin store](/store/plugins) and [plugin development](/development/plugins/overview).
