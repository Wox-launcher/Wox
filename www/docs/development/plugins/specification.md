...
| TriggerKeywords | true     | Refer [Trigger keyword](./query-model.md) section            | string[]   | ["pm","wpm"]                                               |
| Commands        | false    | Refer [Command](./query-model.md) section                    | Command[]  | [{"Command":"install","Description:"Install Wox Plugins"}] |
